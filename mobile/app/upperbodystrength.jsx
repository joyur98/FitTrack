...
const workouts = [
  ...
  { 
    ...
    desc: "4 sets × 10 reps • Chest & triceps",
    emoji: "🏋️",
    calories: 45
  },
  { 
    title: "Bent Over Rows", 
    desc: "4 sets × 12 reps • Back & biceps",
    emoji: "🚣",
    calories: 42
  },
  { 
    title: "Shoulder Press", 
    desc: "3 sets × 12 reps • Shoulders & arms",
    emoji: "⬆️",
    calories: 35
  },
  { 
    title: "Bicep Curls", 
    desc: "3 sets × 15 reps • Biceps focus",
    emoji: "💪",
    calories: 30
  },
  { 
    title: "Tricep Dips", 
    desc: "3 sets × 12 reps • Triceps focus",
    emoji: "👇",
    calories: 32
  },
  { 
    title: "Plank to Push-Up", 
    desc: "3 sets × 10 reps • Core & upper body",
    emoji: "🔄",
    calories: 38
  },
  { 
    title: "Mountain Climbers", 
    desc: "3 minutes • Core & cardio burn",
    emoji: "⛰️",
    calories: 25
  },
  { 
    title: "High Plank Hold", 
    desc: "3 sets × 45 seconds • Core & arms stability",
    emoji: "🛡️",
    calories: 28
  },
  { 
    title: "Stretch & Cool Down", 
    desc: "5 minutes • Upper body recovery",
    emoji: "🧘",
    calories: 15
  },
];
...
export default function UpperBodyStrengthScreen() {
  ...
  // Fetch dark mode preference from Firestore
  useEffect(() => {
  ...
  const handleCompleteWorkout = async () => {
    ...
    try {
      ...
      Alert.alert(
        "🎉 Workout Completed!",
        `You've burned ${totalCalories} calories!\n\nGreat job building upper body strength!`,
        [
          {
            text: "View Progress",
      ...
      >
        ...
        >
          ...
          <View style={styles.headerCenter}>
            <Text style={[styles.title, { color: currentTheme.primaryText }]}>Upper Body Strength</Text>
        ...
        >
          ...
          <View style={styles.statsContainer}>
            <View style={styles.statItem}>
              <Text style={[styles.statValue, { color: currentTheme.statValue }]}>40</Text>
