      ...
      >
        ...
        >
          ...
          <View style={styles.headerCenter}>
            <Text style={[styles.title, { color: currentTheme.primaryText }]}>Full Body Workout</Text>
            <Text style={[styles.subtitle, { color: currentTheme.secondaryText }]}>
              45 Minutes • Complete Body Training
            </Text>
          </View>
        ...
        >
          ...
          <View style={styles.statsContainer}>
            <View style={styles.statItem}>
              <Text style={[styles.statValue, { color: currentTheme.statValue }]}>45</Text>
